    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Provide basic details about your questionnaire
        </p>
      </div>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormDescription>
              Help participants understand the purpose of this questionnaire
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormDescription>
              Categorize your questionnaire for better discoverability
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription>
                When should participants be able to start?
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription>
                When should the questionnaire close?
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
